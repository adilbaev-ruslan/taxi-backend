...
<x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Company update: ') . $company->user->name }}
        </h2>
    </x-slot>
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{route('owner.companies.update', ['company' => $company->id])}}">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
                        ...
                        <div class="flex flex-col">
                                ...
                                <option value="1" {{ $company->working == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $company->working == 0 ? 'selected' : '' }}>Inactive</option>
                          </select>
                        ...
                        <div class="mb-4">
                            <div class="mb-4 grid grid-cols-2 gap-4">
                              <div class="flex flex-col">
                                ...
                                <input name="licence_number" value="{{ $company->licence_number }}" type="text" class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
                              ...
                              <div class="flex flex-col">
                                ...
                                <input name="expiry_date" value="{{ $company->expiry_date }}" type="date" class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
